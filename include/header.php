                    ...
                    <div class="navbar-collapse collapse w-100" id="navbar">
                        <ul class="navbar-nav ml-auto">
							...
							<li class="nav-item dropdown megamenu-li">
                                <a class="nav-link dropdown-toggle" href="apropos.php">A Propos</a>
                            </li>
							
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="section.php">Section</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="gallery.php">Gallery</a>
                            </li>                                                   
                            <li class="nav-item dropdown">
